...
import Abouts from'../public/about-img-1.jpg'
  ...
  <div className="container">
    <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
      <div className="col-12 col-lg-6 col-xl-5">
        {/* <img className="img-fluid rounded" loading="lazy" src="../public/about-img-1.jpg" alt="About 1" /> */}
                <img src={Abouts}gi className="img-fluid" />
      </div>
